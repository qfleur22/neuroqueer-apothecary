...
export const shopifyCatalog: ShopifyCatalogProduct[] = [
  {
    ...
    librarySlugs: ['so-you-think-youre-hypermobile', 'eds-checklist'],
  ...
  },
  {
    ...
    librarySlugs: ['queer-sex-bodily-autonomy'],
    salesHref: '/bodily-autonomy',
    exportPrice: '0.00',
  },
  {
    ...
    librarySlugs: ['boundaries-consent-red-flags-worksheet'],
    salesHref: '/bodily-autonomy',
    exportPrice: '0.00',
  },
]
